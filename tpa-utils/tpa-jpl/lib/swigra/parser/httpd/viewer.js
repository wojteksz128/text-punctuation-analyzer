...
function forestviewer(element) {
    ...
    this.helper = {};
    var reccheck = 0;
    this.set_location = function (newval) {
        this.unload();
    ...
    this.set_forest = function (newval) {
        if (reccheck)
            return;
        reccheck++;
...
forestviewer.prototype.showforest = function (input) {
    ...
    this.set_forest(forest); /* TODO: recurse check */
...
forestviewer.prototype.load = function (input) {
    ...
    this.set_forest(newforest); /* TODO: recurse check */
...
function synspreadviewer(element) {
    ...
    this.isnodevisible = this.nodevisible = function (x) {
        return true;
    };
    ...
    this.ismergeable = this.nodemergeable = function (x) {
        return false;
    };
...
synspreadviewer.prototype.recalc_stats = function () {
    ...
    listtrees(this.current.root, function (a, b) {
        return b ? -1 : a;
    }, 1);
}
